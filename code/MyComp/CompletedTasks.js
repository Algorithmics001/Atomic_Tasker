                ...
                <ScrollView style={{ backgroundColor: colors[7] }}>
                    {todos.map((todo) => (
                        <View key={todo.id} style={styles.viewStyle}>
                            <View style={{ backgroundColor: colors[3], borderTopEndRadius: Scale * 5, flex: 1, flexDirection: 'row', alignContent: 'center', alignItems: 'center'}}>
                                {/* <TouchableOpacity
                                    style={{
                            ...
                            >
                                    ...
                                    <View style={{ 
                                        ...
                                        >
                                            <FontAwesome5 name={'undo'} size={iconSize} color={colors[3]} />
                                        </View>
                                        <Text style={styles.doneText}>Restore</Text>
                                    </View>
