...
exports.editTaskByID = (TaskID, attrib, newValue) => {
    RNFS.readFile(path)
        .then(value => {
            // Parse the JSON data
            const jsonData = JSON.parse(value);
